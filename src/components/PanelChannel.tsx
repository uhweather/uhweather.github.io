  ...
  return (
    <label className={`absolute left-1.5 top-1.5 z-10 ${className}`}>
      ...
      <select
        ...
        className="w-[4.5rem] cursor-pointer appearance-none rounded border border-white/20 bg-black/70 px-1.5 py-0.5 text-[10px] font-medium text-white outline-none backdrop-blur-sm transition-colors hover:bg-black/85 focus-visible:ring-2 focus-visible:ring-white/60 sm:w-[5.5rem] sm:text-xs"
      >
